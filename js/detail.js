...
$(function () {
                                ...
                                .append($('<ul class="tm-ind-panel">')
                                    .append($('<li class="tm-ind-item tm-ind-sellCount canClick">')
                                        .append($('<div class="tm-indcon">')
                                            ...
                                            .append($('<span class="tm-count">').text(good.sale_volume))
                                            )
                                        )
                                    .append($('<li class="tm-ind-item tm-ind-sellCount canClick">')
                                        .append($('<div class="tm-indcon">')
                                    ...
                                    .append($('<li class="tm-ind-item tm-ind-sellCount canClick">')
                                        .append($('<div class="tm-indcon">')
                                            ...
                                            .append($('<span class="tm-count">').text(good.appraise.length))
                                            )
                                        )
                                    )
                                .append($('<div class="clear">'))
                                                    ...
                                                    /*数量*/
                                                        .append($('<div class="theme-options2">')
                                                            ...
                                                            .append($('<dd>')
                                                                ...
                                                                .append($('<input id="text_box" name="" type="text" value="1" style="width:30px;height: 28px"/>'))
                            ...
                            .append($('<div class="pay">')
                                .append($('<li>')
                                    .append($('<div class="clearfix tb-btn tb-btn-buy theme-login">')
                                        .append($('<a id="LikBuy" title="点此按钮到下一步确认购买信息" href="javascript:;">').text('立即购买'))
                                        )
                                    )
                                .append($('<li>')
                                    .append($('<div class="clearfix tb-btn tb-btn-buy theme-login">')
                                        .append($('<a id="LikBasket" title="加入购物车" href="javascript:;">').text('加入购物车'))
                                        )
                                    )
                                )
                            )
    ...
    function add_cart(uid, flag) {
        if (!isBlank(uid) && flag === "1") {
            //    判断cookies有值 且是登录状态
            //    发送请求
            let count = $('#text_box').val();
            let quantity = 0;
            ...
            $.get("http://127.0.0.1:5000/api/v1/cart/", get_param, function (data) {
                // quantity += data;
                // console.log(quantity);
                count = data + parseInt(count);
                console.log(count);
                let post_param = {
                    'uid': uid,
                    'good_id': good_id,
                ...
                $.post("http://127.0.0.1:5000/api/v1/cart/", post_param, function () {
                });
                // location.reload()
            });
            // alert('加入到购物车, 数量：'+count);
